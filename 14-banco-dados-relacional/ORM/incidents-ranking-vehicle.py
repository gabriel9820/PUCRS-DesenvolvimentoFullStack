...
vehicleRanking = session.query(
    ...
    incidents.City.region == "Interior",
    sa.or_(incidents.Incidents.description == "roubo_veiculo", incidents.Incidents.description == "furto_veiculos")
).group_by(
...
print(pd.DataFrame(vehicleRanking))